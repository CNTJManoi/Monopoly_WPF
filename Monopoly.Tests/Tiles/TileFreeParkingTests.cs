    ...
    public class TileFreeParkingTests
    {
        ...
        public void DoAction_AddsDescriptionToGameInfo()
        {
            ...
            Assert.True(game.GameInfo.Where(x =>
                x.Contains(string.Format(Logic.Properties.Language.moves, game.CurrentPlayer.Name, "Free Parking"))).Count() > 0);
        }
        ...
        public void DoAction_AddsTreasureToGameInfo_IfTreasureIsPositive()
        {
            ...
            // Assert
            Assert.True(game.GameInfo.Where(x =>
                x.Contains(string.Format(Logic.Properties.Language.freeparkingpay, game.CurrentPlayer.Name,
                    100))).Count() > 0);
        ...
        public void GetCardInformation_ReturnsCorrectString()
        {
            ...
            // Assert
            Assert.Equal(Monopoly.Logic.Properties.Language.freeparking, cardInfo);
        }
    }
}
