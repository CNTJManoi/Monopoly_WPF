...
namespace Monopoly.Tests.Tiles
{
    public class TileRailRoadTests
    {
        ...
        public void DoAction_WhenOwnerIsNull_ShouldNotChargePlayer()
        {
            ...
            var tile = new TileRailRoad(game, "Reading Railroad", new int[] { 25, 50, 100, 200 }, 100, 200);
            // Act
        ...
        public void GetCardInformation_ShouldReturnCorrectString()
        {
            ...
            // Assert
            Assert.Equal(
                string.Format(Logic.Properties.Language.railroad, tile.Description, Environment.NewLine, Logic.Properties.Language.propertyowner, tile.Price,
