...
public class TileRailRoad : TileBuyable
{
    ...
    {
        var railRoadOwner = Owner == null ? Properties.Language.propertyowner : Owner.Name;
        return string.Format(Properties.Language.railroad, Description, Environment.NewLine, railRoadOwner, Price,
